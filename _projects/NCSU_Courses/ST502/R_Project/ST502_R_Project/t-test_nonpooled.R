...
v = floor(((ns_variance/n1)+(s_variance/n2))^2/((((ns_variance/n1)^2)/(n1-1))+(((s_variance/n2)^2)/(n2-1))))


#Test Statistic
T = (ns_samplemean - s_samplemean - 0)/sqrt((ns_variance/n1)+(s_variance/n2))


#Critical Value
qt(p=0.05/2, df=158, lower.tail = FALSE)
...
###############################
t.test(framingham_data_nonsmokers$sysBP, framingham_data_smokers$sysBP, var.equal = FALSE)
